...
class ProductsBloc {
  ...
  fetchAllProducts(String id) async {
    print(' start fetch all productssssssssssssssssssssssssssssssssssssss where id is $id');
    ...
    if (products.containsKey(id) &&
      ...
      print(' api of fetchhhhhhhhhhhhhhhhh products is ${apiProvider.fetchProductList(productsFilter)}');
