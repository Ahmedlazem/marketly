...
class _FilterProduct2State extends State<FilterProduct2> {
  ...
  RangeValues newRange1=RangeValues(0, 1000000);
  double startRange=0.0;
  double  endRang=1000000.0;
  @override
  void initState() {
    super.initState();
        ...
        actions: [
          FlatButton(
            ...
            onPressed: () {
              ...
              setState(() {
                appStateModel.updateRangeValue(RangeValues(0, 1000000));
              });
            },
          )
        ],
                ...
                child:
                  Column(
                    children: [
                      ...
                      //     min: 0,
                      //     max:
                      //     appStateModel.blocks.maxPrice.toDouble(),
                      ...
                      FormBuilderTextField(
                        ...
                        onChanged: (val){
                          setState(() {
                            startRange=double.tryParse(val);
                            newRange1=RangeValues(startRange, endRang);
                            appStateModel.updateRangeValue((newRange1));
                          });
                        ...
                        //   appStateModel.updateRangeValue(newRange);
                        //   setState(() {
                        //    // appStateModel.selectedRange     = 1.0;
                        //   });
                        // },
                      ...
                      FormBuilderTextField(
                        ...
                        validator: FormBuilderValidators.compose([
                          FormBuilderValidators.required(context),
                          FormBuilderValidators.numeric(context),
                          FormBuilderValidators.max(context, 1000000000),
                        ]),
                        keyboardType: TextInputType.number,
                      ),
                    ],
