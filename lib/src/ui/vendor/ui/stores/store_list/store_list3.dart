...
class StoreCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
   print( ' is closeeeeeeeeeeee prameter ${store.isClose}');
    ...
    return Container(
      ...
      child: Card(
        ...
        child: InkWell(
         ...
         // onTap: !store.isClose?() => openDetails(store, context):(){},
          child: new Stack(
            children: <Widget>[
              featuredImage,
              new BackdropFilter(
              ...
              new Positioned(
                ...
                CircleAvatar(
                 ...
                 // foregroundColor: Colors.blue,
                  radius: 35,child: Icon(Icons.lock_clock,color: Theme.of(context).errorColor,size: 60,)):Container(),
