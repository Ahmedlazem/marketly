...
class BannerSlider3 extends StatefulWidget {
  ...
  final String lang;
  BannerSlider3({Key key, this.block, this.onBannerClick, this.lang})
      : super(key: key);
  @override
...
class _BannerSlider3State extends State<BannerSlider3> {
  ...
  void getNewChildren() {
    print(
        ' in ui folder banner silder33333333333333333333333333333333333333333333333333333333333333333333333333333333333333');
    newChildren.clear();
    final x = widget.block.children;
    x.forEach((e) {
      if ((e.description[0] + e.description[1]) == widget.lang) {
        print(
            'descraption isssssssssssssssssssssssssssssssssss ${e.description}');
        print('descraption isssssssssssssssssssssssssssssssssss ${e.sort}');
        newChildren.add(e);
      } else {
        return;
      }
