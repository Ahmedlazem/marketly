...
//print(' category scroll in blocks inside uiiiiiiiiiiiiiii  categoryyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy');
    final bool isDesktop = isDisplayDesktop(context);
    print('widget block id ${widget.block.linkId}');
//print('widget cat parenrt before transfere to list ${widget.categories.last.parent}');

    // ignore: unrelated_type_equality_checks
    List<Category> categories = widget.categories.where((cat) => cat.parent ==widget.block.linkId).toList();
    //widget.block.linkId
  //  print("catgories areeeeeeeeeeeee ${categories[0].id}");
    return categories.isNotEmpty? SliverList(
                ...
                Expanded(
                    child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          print("inside list view of catgroy scroll");
                          return
                            Container(
  ...
  Widget build(BuildContext context) {
    ...
    return categories.isNotEmpty? SliverList(
      delegate: SliverChildListDelegate(
        [
          Container(
            height: isDesktop ? 330 :


            widget.block.childHeight.toDouble(),
