...
/// hatly and 3lany scroll list
  final Block block;
  final Function onBannerClick;
  final String lang;
  BannerScrollList({Key key, this.block, this.onBannerClick, this.lang}) : super(key: key);
...
class _BannerScrollListState extends State<BannerScrollList> {
  ...
  Widget build(BuildContext context) {
    print(' childrennnnnnnnnnnnnnnn iss ${newChildren.length}  ');
    return newChildren.isNotEmpty? SliverList(
      delegate: SliverChildListDelegate(
        [
          Container(
            height: widget.block.childHeight.toDouble()+20,
