...
class _VendorCategoryGridListState extends State<VendorCategoryGridList> {
  ...
  //  print( ' in ui folders ui block in stores in store grid  start stores build');
...
class _VendorCategoryStadiumGridListState extends State<VendorCategoryStadiumGridList> {
  ...
  @override
  Widget build(BuildContext context) {
    //print( ' in ui folders block in stores in store grid  start stores build vendore cat stidum');
    final bool isDesktop = isDisplayDesktop(context);
