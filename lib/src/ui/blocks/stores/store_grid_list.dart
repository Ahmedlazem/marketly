...
class _StoreGridListState extends State<StoreGridList> {
  ...
  //  print( ' in block in stores in store grid  start stores build');
  ...
  onStoreClick(StoreModel store) {
   // print(' in store click kkkkkkkkkkkkkkkkkkkkkkkkkkk');
    Navigator.push(
        context,
        MaterialPageRoute(
...
class _StoreStadiumGridListState extends State<StoreStadiumGridList> {
  @override
  Widget build(BuildContext context) {
  //  print( ' in ui folders block in stores in store grid  start stores build');
    final bool isDesktop = isDisplayDesktop(context);
