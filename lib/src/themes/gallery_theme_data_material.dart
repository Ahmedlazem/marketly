      ...
      tabBarTheme: TabBarTheme(
        ...
        colorScheme: new ColorScheme(
           ...
           // primary: Colors.red,//Color(0xff6200ee),
            primaryVariant: Color(0xff1a73e8),//const Color(0xff3700b3),
            secondary:  Color(0xff1a73e8),
            //Color(0xff03dac6),
            secondaryVariant: const Color(0xff1a73e8),
            //Color(0xff018786),
        ...
        buttonTheme: ButtonThemeData(
          ...
          colorScheme: new ColorScheme(
            ...
            //accentColor:Color(0xff1a73e8),
              //Color(0xff03dac6),
              primaryVariant: const Color(0xff1a73e8),
              //Color(0xff03dac6),
  ...
  static ThemeData themeArabicDataLight() {
    return ThemeData(
      ...
      buttonTheme: ButtonThemeData(
        ...
        height: 45.0,
        colorScheme: new ColorScheme(
            primary: Color(0xff1a73e8),//Color(0xff6200ee),
            primaryVariant: Colors.blueAccent,
            //Colors.greenAccent,//const Color(0xff3700b3),
            secondary:Color(0xff1a73e8),
            //Color(0xff03dac6),
            secondaryVariant: const Color(0xff1a73e8),
            //Color(0xff018786),
