...
class _AppState extends State<App> with TickerProviderStateMixin {
  ...
  Future<bool> locationEnable() async {
    var y = await location.serviceEnabled();
    setState(() {
      _serviceEnabled = y;
    });
  }
  ...
  BottomNavigationBar buildBottomNavigationBar(BuildContext context) {
    return BottomNavigationBar(
      ...
      items: [
        ...
        /// cat in bottom Navigator wiil remove
        // BottomNavigationBarItem(
  ...
  Future<void> initOneSignal() async {
    ...
    // print('app id on onsignallllllllllllllllllllllllllllllllll is  ${model.blocks.settings.onesignalAppId}, ');
    await OneSignal.shared.init("c9c0b1ac-a1cd-41a3-9e36-2a5f927a7a95",
    ...
    // await OneSignal.shared.init(currentFlavour.oneSignalKey, iOSSettings: <OSiOSSettings, dynamic>{ OSiOSSettings.autoPrompt: true, OSiOSSettings.inAppLaunchUrl: true });
    ...
    model.apiProvider.post(
        ...
        {'onesignal_user_id': model.oneSignalPlayerId});
    //}
  }
