...
//     loading = true;
//     notifyListeners();
//     final response = await apiProvider.post( '/wp-admin/admin-ajax.php?action=mstore_flutter-vendors' + '&lang=' + filter['lan'] + '&flutter_app=' + '1',filter);
//     loading = false;
//     if(filter['search'] != '')
//     stores = storeModelFromJson(response.body);
//     hasMoreItems = stores.length > 9;
